    ...
    <CardContent class="p-6">
      <form class="w-full space-y-6" @submit.prevent="submit">
        ...
        <fieldset class="space-y-2">
          <legend class="text-muted-foreground text-sm font-medium">
            {{ t('settings.mode') }}
          </legend>
        ...
        <fieldset class="space-y-3">
          ...
          <div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
            <Button
              ...
              :key="preset.name"
              type="button"
              class="h-auto justify-between rounded-2xl px-4 py-3 text-left"
        ...
        <Button class="rounded-2xl" type="submit" size="lg">
          {{ t('settings.save') }}
        </Button>
      </form>
    </CardContent>
